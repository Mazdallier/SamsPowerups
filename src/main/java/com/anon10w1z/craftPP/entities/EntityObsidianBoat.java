...
public class EntityObsidianBoat extends Entity
{
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40.0F)
            {
                ...
                if (!flag)
                {
                    this.func_145778_a(CppItems.obsidian_boat, 1, 0.0F);
                }
    ...
    public void onUpdate()
    {
        ...
        for (int i = 0; i < b0; ++i)
        {
            ...
            if (this.worldObj.isAABBInMaterial(axisalignedbb, Material.lava))
            {
                ...
                if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase)  {
            		((EntityLivingBase) this.riddenByEntity).addPotionEffect(new PotionEffect(Potion.fireResistance.id, 10, 1));
        ...
        if (d10 > 0.26249999999999996D)
        {
            ...
            for (j = 0; (double)j < 1.0D + d10 * 60.0D; ++j)
            {
                ...
                if (this.rand.nextBoolean())
                {
                    ...
                    this.worldObj.spawnParticle("lava", d8, this.posY - 0.125D, d9, this.motionX, this.motionY, this.motionZ);
                }
                else
                {
        ...
        else
        {
            ...
            if (this.isCollidedHorizontally && d10 > 100)
            {
    ...
    protected void updateFallState(double p_70064_1_, boolean p_70064_3_)
    {
        ...
        if (p_70064_3_)
        {
            if (this.fallDistance > 100.0F)
            {
                ...
                if (!this.worldObj.isRemote && !this.isDead)
                {
                    ...
                    for (l = 0; l < 5; ++l)
                    {
                        this.func_145778_a(Item.getItemFromBlock(Blocks.obsidian), 5, 0.0F);
                    }
                }
        ...
        else if (this.worldObj.getBlock(i, j - 1, k).getMaterial() != Material.lava && p_70064_1_ < 0.0D)
        {
