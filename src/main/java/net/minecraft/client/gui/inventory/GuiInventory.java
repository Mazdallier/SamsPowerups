...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    //assets.samspowerups.textures.items
  private ResourceLocation field_rrrr =   new ResourceLocation("samspowerups:textures/gui/container/inventory33.png");

    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        
        if(ContainerPlayer.craftSize == 2)
        	this.mc.getTextureManager().bindTexture(field_147001_a);
	   else
		   this.mc.getTextureManager().bindTexture(field_rrrr);
        int k = this.guiLeft;
        int l = this.guiTop;
